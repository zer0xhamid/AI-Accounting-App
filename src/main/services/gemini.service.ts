...
- اسم الشخص هو أي اسم علم (اسم إنسان) مذكور في الجملة
...
الرد:
{"type":"شراء","person":"أحمد","items":[{"name":"خشب زان","quantity":10,"unit":"لوح","specs":null}],"total_amount":5000,"paid_amount":3000,"remaining_amount":2000,"payment_method":"كاش","notes":null}

المستخدم: "بعت لخالد مطبخ بـ 80 ألف آجل"
الرد:
{"type":"بيع","person":"خالد","items":[{"name":"مطبخ","quantity":1,"unit":"قطعة","specs":null}],"total_amount":80000,"paid_amount":0,"remaining_amount":80000,"payment_method":"آجل","notes":null}

المستخدم: "بعت 15 باب لمحمد أبو عمر بـ 45 ألف ودفع 20 ألف"
الرد:
{"type":"بيع","person":"محمد أبو عمر","items":[{"name":"باب","quantity":15,"unit":"قطعة","specs":null}],"total_amount":45000,"paid_amount":20000,"remaining_amount":25000,"payment_method":"كاش","notes":null}

المستخدم: "خالد دفعلي 20 ألف"
الرد:
{"type":"تحصيل","person":"خالد","items":[],"total_amount":20000,"paid_amount":20000,"remaining_amount":0,"payment_method":"كاش","notes":null}

المستخدم: "دفعت إيجار المحل 5000"
الرد:
{"type":"مصروف","person":null,"items":[{"name":"إيجار المحل","quantity":1,"unit":"عدد","specs":null}],"total_amount":5000,"paid_amount":5000,"remaining_amount":0,"payment_method":"كاش","expense_category":"إيجار","notes":null}

المستخدم: "اشتريت 20 لوح موسكي 2.4 متر و 15 لوح زان 3 متر بـ 45 ألف من محمد ودفعت النص"
الرد:
{"type":"شراء","person":"محمد","items":[{"name":"خشب موسكي","quantity":20,"unit":"لوح","specs":"2.4 متر"},{"name":"خشب زان","quantity":15,"unit":"لوح","specs":"3 متر"}],"total_amount":45000,"paid_amount":22500,"remaining_amount":22500,"payment_method":"كاش","notes":null}

المستخدم: "بعت لشركة المعمار 3 غرف نوم و 2 دولاب بـ 200 ألف ودفعوا 100 ألف"
الرد:
{"type":"بيع","person":"شركة المعمار","items":[{"name":"غرفة نوم","quantity":3,"unit":"قطعة","specs":null},{"name":"دولاب","quantity":2,"unit":"قطعة","specs":null}],"total_amount":200000,"paid_amount":100000,"remaining_amount":100000,"payment_method":"كاش","notes":null}

المستخدم: "بعت 5 ابواب كل باب 3 متر طول و عرض نص متر حشو MDF لخالد بـ 25 ألف كاش"
الرد:
{"type":"بيع","person":"خالد","items":[{"name":"باب","quantity":5,"unit":"قطعة","specs":"طول 3 متر × عرض 0.5 متر حشو MDF"}],"total_amount":25000,"paid_amount":25000,"remaining_amount":0,"payment_method":"كاش","notes":null}

المستخدم: "بعت مطبخ 6 متر لأحمد بـ 120 ألف ودفع 50 ألف"
الرد:
{"type":"بيع","person":"أحمد","items":[{"name":"مطبخ","quantity":1,"unit":"قطعة","specs":"6 متر"}],"total_amount":120000,"paid_amount":50000,"remaining_amount":70000,"payment_method":"كاش","notes":null}

المستخدم: "ضيف في المخزن 10 لوح خشب موسكي و 5 لوح أبلكاش و 8 لوح MDF"
الرد:
{"type":"إضافة_مخزن","person":null,"items":[{"name":"خشب موسكي","quantity":10,"unit":"لوح","specs":null},{"name":"أبلكاش","quantity":5,"unit":"لوح","specs":null},{"name":"MDF","quantity":8,"unit":"لوح","specs":null}],"total_amount":0,"paid_amount":0,"remaining_amount":0,"payment_method":"كاش","notes":"إضافة مخزون"}`
...
السؤال: ${question}`
  ...
  ): Promise<{ material_name: string; quantity: number; unit: string }[]> {
    const apiKey = this.getApiKey()
...
[{"material_name": "اسم المادة بالظبط من المخزن", "quantity": الكمية_المطلوبة, "unit": "الوحدة"}]
